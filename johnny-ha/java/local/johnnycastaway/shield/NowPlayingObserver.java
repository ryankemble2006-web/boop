...
public final class NowPlayingObserver {
 ...
 public NowPlayingObserver(Context context,NowPlayingView target){
 ...
 public void start(){if(running)return;running=true;view.begin();if(manager==null)return;
  ...
  catch(SecurityException denied){view.bind(null,null,null);Log.i("JohnnyMedia","Music information access not enabled");}}
