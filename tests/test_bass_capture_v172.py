...
public final class BassHarness {
 ...
 public static void main(String[] args){
  ...
  BassCaptureState.start();BassCaptureState.publish(.7f,100);
  check(BassCaptureState.level(100)==.7f,"fresh sample");
  check(BassCaptureState.level(251)==0,"stale sample does not dance");
  BassCaptureState.stop();check(!BassCaptureState.running&&BassCaptureState.level(100)==0,"stop clears sample");
