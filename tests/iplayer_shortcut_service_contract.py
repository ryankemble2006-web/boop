...
for programme in ("eastenders", "casualty"):
    ...
    assert "USB debugging" in main and "Network debugging" in main, "Shield setup must enable both debugging switches before app-local ADB approval"
...
print("PASS: both shortcuts are standalone, silently reset iPlayer, choose the first real profile, and require both Shield debugging switches")
