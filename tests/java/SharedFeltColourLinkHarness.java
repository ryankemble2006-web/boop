...
public final class SharedFeltColourLinkHarness {
    static int checks;
    static void check(boolean ok, String message) {
        checks++; if (!ok) throw new AssertionError(message);
    }
    static JSONObject helper(String id) throws Exception {
        return SharedFeltColourHaProtocol.createBody().put("id", id);
    }
    static final class Events implements SharedFeltColourLink.Listener {
    ...
    static final class Fake implements SharedFeltColourLink.Channel {
        JSONArray helpers = new JSONArray();
        String value = "BOOP_FELT_V1|220", entity = "input_text.renamed_colour";
        String failType;
        boolean defer, permitCreate = true;
        final List<String> requests = new ArrayList<>();
        final List<Runnable> pending = new ArrayList<>();
        public void request(String type, JSONObject body, SharedFeltColourLink.Reply reply) {
            requests.add(type);
            Runnable answer = () -> {
                try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Events e = new Events(); SharedFeltColourLink link = new SharedFeltColourLink(a, e, () -> 280);
        link.begin(false);
        ...
        link.event("input_text.other", "BOOP_FELT_V1|50");
        check(e.colour == null, "Ignore other entities");
        link.event(a.entity, "BOOP_FELT_V1|120");
        ...
        Events m = new Events(); new SharedFeltColourLink(missing, m, () -> 270).begin(false);
        ...
        new SharedFeltColourLink(create, c, () -> 270).begin(true);
        ...
        Events d = new Events(); new SharedFeltColourLink(duplicate, d, () -> 190).begin(true);
        ...
        Events b = new Events(); new SharedFeltColourLink(bad, b, () -> 190).begin(true);
        ...
        Events l = new Events(); SharedFeltColourLink stopped = new SharedFeltColourLink(late, l, () -> 190);
        ...
        for (String step : List.of("input_text/list", "config/entity_registry/list", "get_states")) {
            ...
            Events no = new Events(); new SharedFeltColourLink(denied, no, () -> 190).begin(false);
        ...
        SharedFeltColourLink failing = new SharedFeltColourLink(loss, lost, () -> 190);
        ...
        System.out.println("SharedFeltColourLinkHarness: " + checks + " checks passed");
    }
}
