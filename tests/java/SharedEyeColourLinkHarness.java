...
public final class SharedEyeColourLinkHarness {
    static int checks;
    static void check(boolean ok, String message) {
        checks++; if (!ok) throw new AssertionError(message);
    }
    static JSONObject helper(String id) throws Exception {
        return SharedEyeColourHaProtocol.createBody().put("id", id);
    }
    static final class Events implements SharedEyeColourLink.Listener {
    ...
    static final class Fake implements SharedEyeColourLink.Channel {
        JSONArray helpers = new JSONArray();
        String value = "BOOP_EYE_V1|220", entity = "input_text.renamed_colour";
        String failType;
        boolean defer, permitCreate = true;
        final List<String> requests = new ArrayList<>();
        final List<Runnable> pending = new ArrayList<>();
        public void request(String type, JSONObject body, SharedEyeColourLink.Reply reply) {
            requests.add(type);
            Runnable answer = () -> {
                try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Events e = new Events(); SharedEyeColourLink link = new SharedEyeColourLink(a, e, () -> 280);
        link.begin(false);
        ...
        link.event("input_text.other", "BOOP_EYE_V1|50");
        check(e.colour == null, "Ignore other entities");
        link.event(a.entity, "BOOP_EYE_V1|120");
        ...
        Events m = new Events(); new SharedEyeColourLink(missing, m, () -> 270).begin(false);
        ...
        new SharedEyeColourLink(create, c, () -> 270).begin(true);
        ...
        Events d = new Events(); new SharedEyeColourLink(duplicate, d, () -> 190).begin(true);
        ...
        Events b = new Events(); new SharedEyeColourLink(bad, b, () -> 190).begin(true);
        ...
        Events l = new Events(); SharedEyeColourLink stopped = new SharedEyeColourLink(late, l, () -> 190);
        ...
        for (String step : List.of("input_text/list", "config/entity_registry/list", "get_states")) {
            ...
            Events no = new Events(); new SharedEyeColourLink(denied, no, () -> 190).begin(false);
        ...
        SharedEyeColourLink failing = new SharedEyeColourLink(loss, lost, () -> 190);
        ...
        System.out.println("SharedEyeColourLinkHarness: " + checks + " checks passed");
    }
}
