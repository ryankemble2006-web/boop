...
class Alpha64WakeIntegrationTest(unittest.TestCase):
    ...
    def test_pixel_wake_path_falls_back_to_latest_partial_when_final_is_empty(self):
        ...
        normalizer = Path('source/BoopWakeTranscriptNormalizer.java').read_text(encoding='utf-8')
        ...
        self.assertIn('final class BoopWakeTranscriptAccumulator', normalizer)
        self.assertIn('latestPartial', normalizer)
