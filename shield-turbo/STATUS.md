...
- read-only only. No settings writes, setprop, sysfs writes, root, above-stock clocks, voltage, or thermal bypass.
...
v0.6.2 / code 23 production blobs have been prepared and are being attached to the live branch for GREEN verification. Do not call it machine-green or physically accepted until the exact live source workflow and real Shield test say so.

## Current state

- v0.6.0 / code 21: physical rollback checkpoint.
- v0.6.1 / code 22: latest completed machine-green candidate.
- v0.6.2 / code 23: active TURBO+ candidate pending exact-live-source CI.
