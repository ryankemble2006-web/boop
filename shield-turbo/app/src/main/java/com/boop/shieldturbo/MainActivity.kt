...
import com.boop.shieldturbo.advanced.AnimationController
import com.boop.shieldturbo.advanced.AnimationSpeed
...
class MainActivity : Activity() {
    ...
    private fun showHome() {
        ...
        val sections = listOf(
            ...
            Triple(TurboSection.ADVANCED, R.string.section_advanced, R.string.section_advanced_help)
        )
    ...
    private fun openSection(section: TurboSection) {
        ...
        when (section) {
            ...
            TurboSection.ADVANCED -> renderAdvanced()
        }
    }
