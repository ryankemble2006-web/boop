...
public final class MainActivity extends Activity {
 ...
 private void configureOpenTransition(){if(Build.VERSION.SDK_INT>=34)overrideActivityTransition(OVERRIDE_TRANSITION_OPEN,R.anim.boop_enter_from_right,R.anim.boop_exit_to_left);}
