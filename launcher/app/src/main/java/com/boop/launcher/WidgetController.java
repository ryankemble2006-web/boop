...
public final class WidgetController {
 ...
 public void pick(){releasePending();setPending(host.allocateAppWidgetId());Intent i=new Intent(AppWidgetManager.ACTION_APPWIDGET_PICK);i.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID,pending);i.putExtra(AppWidgetManager.EXTRA_CUSTOM_INFO,new ArrayList<AppWidgetProviderInfo>());i.putExtra(AppWidgetManager.EXTRA_CUSTOM_EXTRAS,new ArrayList<Bundle>());activity.startActivityForResult(i,PICK);}
