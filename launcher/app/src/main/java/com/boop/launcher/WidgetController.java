...
public final class WidgetController {
 ...
 public void pick(){releasePending();setPending(host.allocateAppWidgetId());Intent i=new Intent(activity,WidgetPickerActivity.class);i.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID,pending);activity.startActivityForResult(i,PICK);}
