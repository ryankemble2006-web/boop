...
MODEL_DIR="${CACHE}/sherpa-onnx-kws-zipformer-gigaspeech-3.3M-2024-01-01"
...
curl -fsSL --retry 3 "$BASE/kws-models/checksum.txt?build=${GITHUB_RUN_ID:-local}" -o "$CACHE/checksum.txt"
