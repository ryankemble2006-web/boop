...
assert "package: name='com.boop.notificationlab'" in badging and "versionCode='1'" in badging
...
name='BOOP-Test-Sender-v1.apk';shutil.copyfile(apk,out/name)
(out/'notification-sender-receipt.json').write_text(json.dumps(dict(
    ...
    signerSha256=expected,package='com.boop.notificationlab',versionCode=1),indent=2)+'\n')
