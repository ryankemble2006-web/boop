...
and redraws only an iris/pupil patch from the same runtime bitmap with a smooth
left/right, slightly downward reading offset.
"""
...
def main() -> None:
    ...
    temp.replace(FACE)
    print('Approved BOOP eyes now zoom and scan like reading while active listening')
