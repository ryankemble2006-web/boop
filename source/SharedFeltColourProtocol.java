...
final class SharedFeltColourProtocol {
    static final String PREFIX = "BOOP_FELT_V1|";
    static final String NAME = "BOOP shared felt colour";
    static final String MARKER = "^BOOP_FELT_V1\\|(?:[0-9]|[1-9][0-9]|[12][0-9]{2}|3[0-5][0-9])$";
    private SharedFeltColourProtocol() { }
