...
final class SharedHandColourProtocol {
    static final String PREFIX = "BOOP_HAND_V1|";
    static final String NAME = "BOOP shared hand colour";
    static final String MARKER = "^BOOP_HAND_V1\\|(?:[0-9]|[1-9][0-9]|[12][0-9]{2}|3[0-5][0-9])$";
    private SharedHandColourProtocol() { }
    static void requireHue(int hue) {
        if (hue < 0 || hue > 359) throw new IllegalArgumentException("Invalid hand hue");
    }
    ...
    static Integer decode(String value) {
        if (value == null || value.length() > PREFIX.length() + 3 || !value.startsWith(PREFIX)) return null;
