...
final class SharedEyeColourHaProtocol {
    private SharedEyeColourHaProtocol() { }
    static JSONObject createBody() throws JSONException {
        return new JSONObject().put("name", SharedEyeColourProtocol.NAME)
                .put("min", 0).put("max", 32).put("mode", "text")
                .put("pattern", SharedEyeColourProtocol.MARKER);
    }
    ...
    static Integer readHue(Object result, String entity) {
        ...
        return SharedEyeColourProtocol.decode(value);
    }
}
