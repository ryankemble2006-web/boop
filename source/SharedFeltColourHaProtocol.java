...
final class SharedFeltColourHaProtocol {
    private SharedFeltColourHaProtocol() { }
    static JSONObject createBody() throws JSONException {
        return new JSONObject().put("name", SharedFeltColourProtocol.NAME)
                .put("min", 0).put("max", 32).put("mode", "text")
                .put("pattern", SharedFeltColourProtocol.MARKER);
    }
    ...
    static Integer readHue(Object result, String entity) {
        ...
        return SharedFeltColourProtocol.decode(value);
    }
}
