...
public final class ClickGateTest {
    ...
    public static void main(String[] args) {
        ...
        gate.arm(100);
        check(gate.claimProfile(101, true, true), "Choose first existing profile");
        check(!gate.claimProfile(146, true, true), "Never double-click the profile chooser");
        check(!gate.claimProfile(2300, true, true), "Exactly one profile selection is allowed per launch");
        ...
        System.out.println("PASS: one profile click, newest episode, once-only, expiry, cancellation");
    }
}
