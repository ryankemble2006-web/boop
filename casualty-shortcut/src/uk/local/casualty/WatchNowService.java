...
public final class WatchNowService extends AccessibilityService {
    ...
    private void stop() {
        if(preparing || returningHome) Log.i("Casualty", "stop() while cleanup active: preparing="+preparing+" returningHome="+returningHome);
        gate.cancel();
        handler.removeCallbacks(check);
        clearCleanup();
    }
    ...
    @Override public void onInterrupt() {
        Log.i("Casualty", "onInterrupt: preparing="+preparing+" returningHome="+returningHome);
        stop();
    }
